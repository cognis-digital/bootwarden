#!/usr/bin/env sh
# Universal installer for bootwarden. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/bootwarden.git"
echo "Installing bootwarden ..."
